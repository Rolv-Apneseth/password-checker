...
# Title
title_label = tk.Label(title_frame, text="Pwned Password Checker", font=(
    "Helvetica", 14, "underline", "bold"), bg="Black", fg="yellow")
...
# entry button
password_submit = ttk.Button(frame2, text="Check password",
                             command=lambda: pass_check(entry.get()), cursor="hand2")
